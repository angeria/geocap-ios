...
class GeoCapUITests: XCTestCase {
    ...
    func testSignUp() {
        ...
        app/*@START_MENU_TOKEN@*/.buttons["Fortsätt med din e-post"]/*[[".otherElements[\"welcomeView\"].buttons[\"Fortsätt med din e-post\"]",".buttons[\"Fortsätt med din e-post\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
